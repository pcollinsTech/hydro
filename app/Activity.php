...
class Activity extends Model
{
    ...
    protected $fillable = ['name', 'slug', 'description', 'content', 'published', 'published_at'];
     ...
     * @return Activity
     */
    public static function loadPublished(string $slug): Activity
    {
        return static::with([
            'user' => function (BelongsTo $query) {
                $query->select('id', 'name');
    ...
    /**
     * Add query scope to get only published activities
     *
     * @param Builder $query
     *
     * @return Builder
    ...
    /**
     * Load only activities related with the user id
     *
     * @param Builder $query
     * @param int $user_id
     *
    ...
    /**
     * Relationship between activities and user
     *
